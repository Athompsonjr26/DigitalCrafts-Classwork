...
describe("fun with strings", function() {
  ...
  xit ("should tell us the first word of 'oh dear' is 'oh'", function() {
...
describe("Temperature", function() {
    ...
    xit("converts freezing temperature", function() {
			expect(f2c(32)).toEqual(0);
		});

    xit("converts boiling temperature", function() {
			expect(f2c(212)).toEqual(100);
		});

    xit("converts body temperature", function() {
			expect(f2c(98.6)).toEqual(37);
		});

    xit("converts an arbitrary temperature", function() {
